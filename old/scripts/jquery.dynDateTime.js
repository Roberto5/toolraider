	...
	$.fn.dynDateTime = function(options) {
		...
		return this.each(function() {
			...
			function onSelect(cal) {
                ...
                {
                    if (this_displayArea.tagName=="INPUT") this_displayArea.value=cal.date.print(p.daFormat); 
                    else this_displayArea.innerHTML = cal.date.print(p.daFormat);
                }
...
Calendar.prototype.create = function (_par) {
	...
	var hh = function (text, cs, navtype) {
		...
		cell.innerHTML = "<div style='color: black;' unselectable='on'>" + text + "</div>";
		return cell;
	};
	...
	if (this.showsTime) {
		...
		(function(){
            ...
            var S = makeTimePart("second", mins, 0, 59);
			var AP = null;
			cell = Calendar.createElement("td", row);
			cell.className = "time";
			cell.colSpan = 2;
